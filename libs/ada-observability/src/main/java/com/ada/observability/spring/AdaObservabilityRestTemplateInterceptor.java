...
public class AdaObservabilityRestTemplateInterceptor implements ClientHttpRequestInterceptor {
  ...
  public AdaObservabilityRestTemplateInterceptor(AdaObservability observability) {
  ...
  public ClientHttpResponse intercept(
    ...
    String correlation =
        observability.currentTrace() == null ? null : observability.currentTrace().correlationId();
    if (correlation != null) {
  ...
  private void add(ExternalCall call) {
    observability.recordExternalCall(call);
  }
}
