...
public class AdaObservabilityProperties {
  ...
  private List<String> hiddenFields = new ArrayList<>(List.of("authorization", "token", "password", "apiKey", "client_secret"));
  private List<String> ignoredPaths = new ArrayList<>(List.of("/actuator/health", "/actuator/metrics"));
