"""File grouping and batch consolidation utilities."""
...
class FileGrouper:
    """Safely groups and consolidates files into a target subfolder."""

    @staticmethod
    def group_files(args: Dict[str, Any]) -> Dict[str, Any]:
