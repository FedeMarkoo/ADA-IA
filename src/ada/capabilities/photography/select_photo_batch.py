        ...
        for item, score in accepted:
            ...
            if write_xmp:
                write_photo_xmp(
                    ...
                    0,
                    score,
                    "Duplicado de ráfaga; se conserva otra toma mejor",
                    label="Amarillo",
                )
    return duplicates
...
def run(args):
    ...
    if repair_only:
        ...
        raw_files = [
            ...
            if path.is_file() and path.suffix.lower() in {".raw", ".cr2", ".nef", ".arw", ".dng", ".raf", ".orf"}
        ]
        ...
        return {
            ...
            "xmp_written": repaired + burst_xmp,
        }
    ...
    if args.get("write_xmp"):
        ...
        for item in records:
            ...
            selected_by_batch = int(review.get("selection_rating", 0) or 0) >= 3 and score >= accept_threshold
