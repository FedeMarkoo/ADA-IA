...
class LiteLlmClient(
    ...
    override fun complete(request: ChatRequest, model: String): LlmCompletion {
        val response = client.post()
            ...
            .body(LiteLlmRequest(model, listOf(LiteLlmMessage("user", request.message))))
            .retrieve()
        ...
        metrics.recordTokens(model, response.usage?.promptTokens, response.usage?.completionTokens)
