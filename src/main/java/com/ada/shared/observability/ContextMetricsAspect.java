...
public class ContextMetricsAspect {
  ...
  public Object measure(ProceedingJoinPoint jp, MeasuredContextItem a) throws Throwable {
    ...
    registry.counter("ada_context_item_invocations_total", "component", a.value()).increment();
    try {
      return jp.proceed();
    } finally {
      s.stop(registry.timer("ada_context_item_duration_seconds", "component", a.value()));
    }
  }
}
