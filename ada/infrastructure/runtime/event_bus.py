...
class EventStore(Protocol):
    def publish_event(self, topic: str, payload: Any, priority: int = 0, dedupe_key: Optional[str] = None, delay_seconds: int = 0) -> int: ...
    def claim_events(self, limit: int = 10, lease_seconds: int = 300, owner: Optional[str] = None) -> List[Dict[str, Any]]: ...
    def finish_event(self, event_id: int, success: bool = True, error: Optional[Any] = None, retry_seconds: int = 0) -> None: ...
